...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InvoicesApi();
  });
  ...
  describe('InvoicesApi', function() {
    ...
    describe('performCancelAction', function() {
      it('should call performCancelAction successfully', function(done) {
        //uncomment below and update the code to test performCancelAction
        //instance.performCancelAction(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('performSendAction', function() {
      it('should call performSendAction successfully', function(done) {
        ...
        //instance.performSendAction(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
