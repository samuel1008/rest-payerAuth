...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V1FileDetailsGet200ResponseFileDetails();
  });
  ...
  describe('V1FileDetailsGet200ResponseFileDetails', function() {
    it('should create an instance of V1FileDetailsGet200ResponseFileDetails', function() {
      // uncomment below and update the code to test V1FileDetailsGet200ResponseFileDetails
      //var instane = new CyberSource.V1FileDetailsGet200ResponseFileDetails();
      //expect(instance).to.be.a(CyberSource.V1FileDetailsGet200ResponseFileDetails);
    });
