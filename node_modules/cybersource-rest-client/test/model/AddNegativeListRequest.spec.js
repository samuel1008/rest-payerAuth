...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.AddNegativeListRequest();
  });
  ...
  describe('AddNegativeListRequest', function() {
    it('should create an instance of AddNegativeListRequest', function() {
      // uncomment below and update the code to test AddNegativeListRequest
      //var instane = new CyberSource.AddNegativeListRequest();
      //expect(instance).to.be.a(CyberSource.AddNegativeListRequest);
    });
