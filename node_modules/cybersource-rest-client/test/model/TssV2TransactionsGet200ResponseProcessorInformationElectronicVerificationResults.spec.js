...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TssV2TransactionsGet200ResponseProcessorInformationElectronicVerificationResults();
  });
  ...
  describe('TssV2TransactionsGet200ResponseProcessorInformationElectronicVerificationResults', function() {
    it('should create an instance of TssV2TransactionsGet200ResponseProcessorInformationElectronicVerificationResults', function() {
      // uncomment below and update the code to test TssV2TransactionsGet200ResponseProcessorInformationElectronicVerificationResults
      //var instane = new CyberSource.TssV2TransactionsGet200ResponseProcessorInformationElectronicVerificationResults();
      //expect(instance).to.be.a(CyberSource.TssV2TransactionsGet200ResponseProcessorInformationElectronicVerificationResults);
    });
