...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsPaymentInformationFluidData();
  });
  ...
  describe('Ptsv2paymentsPaymentInformationFluidData', function() {
    it('should create an instance of Ptsv2paymentsPaymentInformationFluidData', function() {
      // uncomment below and update the code to test Ptsv2paymentsPaymentInformationFluidData
