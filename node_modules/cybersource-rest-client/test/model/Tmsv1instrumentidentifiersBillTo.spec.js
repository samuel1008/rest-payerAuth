...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Tmsv1instrumentidentifiersBillTo();
  });
  ...
  describe('Tmsv1instrumentidentifiersBillTo', function() {
    it('should create an instance of Tmsv1instrumentidentifiersBillTo', function() {
      // uncomment below and update the code to test Tmsv1instrumentidentifiersBillTo
      //var instane = new CyberSource.Tmsv1instrumentidentifiersBillTo();
      //expect(instance).to.be.a(CyberSource.Tmsv1instrumentidentifiersBillTo);
    });
