...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2payoutsRecipientInformation();
  });
  ...
  describe('Ptsv2payoutsRecipientInformation', function() {
    it('should create an instance of Ptsv2payoutsRecipientInformation', function() {
      // uncomment below and update the code to test Ptsv2payoutsRecipientInformation
      //var instane = new CyberSource.Ptsv2payoutsRecipientInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2payoutsRecipientInformation);
    });
