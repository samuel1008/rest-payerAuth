...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CreateBundledDecisionManagerCaseRequest();
  });
  ...
  describe('CreateBundledDecisionManagerCaseRequest', function() {
    it('should create an instance of CreateBundledDecisionManagerCaseRequest', function() {
      // uncomment below and update the code to test CreateBundledDecisionManagerCaseRequest
      //var instane = new CyberSource.CreateBundledDecisionManagerCaseRequest();
      //expect(instance).to.be.a(CyberSource.CreateBundledDecisionManagerCaseRequest);
    });
