...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation();
  });
  ...
  describe('PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation', function() {
    it('should create an instance of PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation', function() {
      // uncomment below and update the code to test PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation
      //var instane = new CyberSource.PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation();
      //expect(instance).to.be.a(CyberSource.PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation);
    });
