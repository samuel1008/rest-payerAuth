...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.RiskV1AddressVerificationsPost201ResponseAddressVerificationInformationStandardAddress();
  });
  ...
  describe('RiskV1AddressVerificationsPost201ResponseAddressVerificationInformationStandardAddress', function() {
    it('should create an instance of RiskV1AddressVerificationsPost201ResponseAddressVerificationInformationStandardAddress', function() {
      // uncomment below and update the code to test RiskV1AddressVerificationsPost201ResponseAddressVerificationInformationStandardAddress
      //var instane = new CyberSource.RiskV1AddressVerificationsPost201ResponseAddressVerificationInformationStandardAddress();
      //expect(instance).to.be.a(CyberSource.RiskV1AddressVerificationsPost201ResponseAddressVerificationInformationStandardAddress);
    });
    ...
    it('should have the property csz (base name: "csz")', function() {
      // uncomment below and update the code to test the property csz
      //var instane = new CyberSource.RiskV1AddressVerificationsPost201ResponseAddressVerificationInformationStandardAddress();
      //expect(instance).to.be();
    });
