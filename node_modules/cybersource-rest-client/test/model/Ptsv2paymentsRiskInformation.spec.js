...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsRiskInformation();
  });
  ...
  describe('Ptsv2paymentsRiskInformation', function() {
    it('should create an instance of Ptsv2paymentsRiskInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentsRiskInformation
      //var instane = new CyberSource.Ptsv2paymentsRiskInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsRiskInformation);
    });
