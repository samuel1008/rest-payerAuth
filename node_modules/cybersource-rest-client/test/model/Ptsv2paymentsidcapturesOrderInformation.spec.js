...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsidcapturesOrderInformation();
  });
  ...
  describe('Ptsv2paymentsidcapturesOrderInformation', function() {
    it('should create an instance of Ptsv2paymentsidcapturesOrderInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentsidcapturesOrderInformation
      //var instane = new CyberSource.Ptsv2paymentsidcapturesOrderInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsidcapturesOrderInformation);
    });
