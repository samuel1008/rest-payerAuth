...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.AuthReversalRequest();
  });
  ...
  describe('AuthReversalRequest', function() {
    it('should create an instance of AuthReversalRequest', function() {
      // uncomment below and update the code to test AuthReversalRequest
      //var instane = new CyberSource.AuthReversalRequest();
      //expect(instance).to.be.a(CyberSource.AuthReversalRequest);
    });
    ...
    it('should have the property reversalInformation (base name: "reversalInformation")', function() {
      // uncomment below and update the code to test the property reversalInformation
      //var instane = new CyberSource.AuthReversalRequest();
      //expect(instance).to.be();
    });
