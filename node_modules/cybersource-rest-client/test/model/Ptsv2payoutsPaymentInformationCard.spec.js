...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2payoutsPaymentInformationCard();
  });
  ...
  describe('Ptsv2payoutsPaymentInformationCard', function() {
    it('should create an instance of Ptsv2payoutsPaymentInformationCard', function() {
      // uncomment below and update the code to test Ptsv2payoutsPaymentInformationCard
      //var instane = new CyberSource.Ptsv2payoutsPaymentInformationCard();
      //expect(instance).to.be.a(CyberSource.Ptsv2payoutsPaymentInformationCard);
    });
