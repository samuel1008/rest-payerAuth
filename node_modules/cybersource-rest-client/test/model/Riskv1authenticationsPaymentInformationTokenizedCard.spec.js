...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1authenticationsPaymentInformationTokenizedCard();
  });
  ...
  describe('Riskv1authenticationsPaymentInformationTokenizedCard', function() {
    it('should create an instance of Riskv1authenticationsPaymentInformationTokenizedCard', function() {
      // uncomment below and update the code to test Riskv1authenticationsPaymentInformationTokenizedCard
