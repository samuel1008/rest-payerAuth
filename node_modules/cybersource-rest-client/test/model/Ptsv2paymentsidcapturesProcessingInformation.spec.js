...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsidcapturesProcessingInformation();
  });
  ...
  describe('Ptsv2paymentsidcapturesProcessingInformation', function() {
    it('should create an instance of Ptsv2paymentsidcapturesProcessingInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentsidcapturesProcessingInformation
      //var instane = new CyberSource.Ptsv2paymentsidcapturesProcessingInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsidcapturesProcessingInformation);
    });
