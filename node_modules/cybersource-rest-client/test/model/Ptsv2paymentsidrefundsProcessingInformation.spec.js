...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsidrefundsProcessingInformation();
  });
  ...
  describe('Ptsv2paymentsidrefundsProcessingInformation', function() {
    it('should create an instance of Ptsv2paymentsidrefundsProcessingInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentsidrefundsProcessingInformation
