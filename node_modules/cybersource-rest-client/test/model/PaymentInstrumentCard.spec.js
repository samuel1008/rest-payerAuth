...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentInstrumentCard();
  });
  ...
  describe('PaymentInstrumentCard', function() {
    it('should create an instance of PaymentInstrumentCard', function() {
      // uncomment below and update the code to test PaymentInstrumentCard
      //var instane = new CyberSource.PaymentInstrumentCard();
      //expect(instance).to.be.a(CyberSource.PaymentInstrumentCard);
    });
