...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1decisionsOrderInformationShipTo();
  });
  ...
  describe('Riskv1decisionsOrderInformationShipTo', function() {
    it('should create an instance of Riskv1decisionsOrderInformationShipTo', function() {
      // uncomment below and update the code to test Riskv1decisionsOrderInformationShipTo
      //var instane = new CyberSource.Riskv1decisionsOrderInformationShipTo();
      //expect(instance).to.be.a(CyberSource.Riskv1decisionsOrderInformationShipTo);
    });
