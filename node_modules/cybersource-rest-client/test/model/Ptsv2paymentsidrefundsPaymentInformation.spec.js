...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsidrefundsPaymentInformation();
  });
  ...
  describe('Ptsv2paymentsidrefundsPaymentInformation', function() {
    it('should create an instance of Ptsv2paymentsidrefundsPaymentInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentsidrefundsPaymentInformation
      //var instane = new CyberSource.Ptsv2paymentsidrefundsPaymentInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsidrefundsPaymentInformation);
    });
