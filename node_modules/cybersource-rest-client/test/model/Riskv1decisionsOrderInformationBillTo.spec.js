...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1decisionsOrderInformationBillTo();
  });
  ...
  describe('Riskv1decisionsOrderInformationBillTo', function() {
    it('should create an instance of Riskv1decisionsOrderInformationBillTo', function() {
      // uncomment below and update the code to test Riskv1decisionsOrderInformationBillTo
      //var instane = new CyberSource.Riskv1decisionsOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.Riskv1decisionsOrderInformationBillTo);
    });
