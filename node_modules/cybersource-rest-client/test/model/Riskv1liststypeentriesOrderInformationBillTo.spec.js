...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1liststypeentriesOrderInformationBillTo();
  });
  ...
  describe('Riskv1liststypeentriesOrderInformationBillTo', function() {
    it('should create an instance of Riskv1liststypeentriesOrderInformationBillTo', function() {
      // uncomment below and update the code to test Riskv1liststypeentriesOrderInformationBillTo
      //var instane = new CyberSource.Riskv1liststypeentriesOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.Riskv1liststypeentriesOrderInformationBillTo);
    });
