...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TssV2TransactionsGet200ResponseOrderInformationAmountDetails();
  });
  ...
  describe('TssV2TransactionsGet200ResponseOrderInformationAmountDetails', function() {
    it('should create an instance of TssV2TransactionsGet200ResponseOrderInformationAmountDetails', function() {
      // uncomment below and update the code to test TssV2TransactionsGet200ResponseOrderInformationAmountDetails
      //var instane = new CyberSource.TssV2TransactionsGet200ResponseOrderInformationAmountDetails();
      //expect(instance).to.be.a(CyberSource.TssV2TransactionsGet200ResponseOrderInformationAmountDetails);
    });
