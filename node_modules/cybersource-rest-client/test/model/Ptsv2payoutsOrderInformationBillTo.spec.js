...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2payoutsOrderInformationBillTo();
  });
  ...
  describe('Ptsv2payoutsOrderInformationBillTo', function() {
    it('should create an instance of Ptsv2payoutsOrderInformationBillTo', function() {
      // uncomment below and update the code to test Ptsv2payoutsOrderInformationBillTo
      //var instane = new CyberSource.Ptsv2payoutsOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.Ptsv2payoutsOrderInformationBillTo);
    });
