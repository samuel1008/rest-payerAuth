...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1decisionsRiskInformation();
  });
  ...
  describe('Riskv1decisionsRiskInformation', function() {
    it('should create an instance of Riskv1decisionsRiskInformation', function() {
      // uncomment below and update the code to test Riskv1decisionsRiskInformation
      //var instane = new CyberSource.Riskv1decisionsRiskInformation();
      //expect(instance).to.be.a(CyberSource.Riskv1decisionsRiskInformation);
    });
