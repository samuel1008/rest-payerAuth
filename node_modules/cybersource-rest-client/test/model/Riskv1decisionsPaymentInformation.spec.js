...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1decisionsPaymentInformation();
  });
  ...
  describe('Riskv1decisionsPaymentInformation', function() {
    it('should create an instance of Riskv1decisionsPaymentInformation', function() {
      // uncomment below and update the code to test Riskv1decisionsPaymentInformation
      //var instane = new CyberSource.Riskv1decisionsPaymentInformation();
      //expect(instance).to.be.a(CyberSource.Riskv1decisionsPaymentInformation);
    });
