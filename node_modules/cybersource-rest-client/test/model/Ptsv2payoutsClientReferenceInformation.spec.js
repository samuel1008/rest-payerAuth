...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2payoutsClientReferenceInformation();
  });
  ...
  describe('Ptsv2payoutsClientReferenceInformation', function() {
    it('should create an instance of Ptsv2payoutsClientReferenceInformation', function() {
      // uncomment below and update the code to test Ptsv2payoutsClientReferenceInformation
      //var instane = new CyberSource.Ptsv2payoutsClientReferenceInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2payoutsClientReferenceInformation);
    });
