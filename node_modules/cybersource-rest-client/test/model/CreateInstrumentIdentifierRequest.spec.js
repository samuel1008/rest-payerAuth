...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CreateInstrumentIdentifierRequest();
  });
  ...
  describe('CreateInstrumentIdentifierRequest', function() {
    it('should create an instance of CreateInstrumentIdentifierRequest', function() {
      // uncomment below and update the code to test CreateInstrumentIdentifierRequest
      //var instane = new CyberSource.CreateInstrumentIdentifierRequest();
      //expect(instance).to.be.a(CyberSource.CreateInstrumentIdentifierRequest);
    });
