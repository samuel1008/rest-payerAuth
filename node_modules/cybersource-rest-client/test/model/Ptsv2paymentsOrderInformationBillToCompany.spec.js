...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsOrderInformationBillToCompany();
  });
  ...
  describe('Ptsv2paymentsOrderInformationBillToCompany', function() {
    it('should create an instance of Ptsv2paymentsOrderInformationBillToCompany', function() {
      // uncomment below and update the code to test Ptsv2paymentsOrderInformationBillToCompany
      //var instane = new CyberSource.Ptsv2paymentsOrderInformationBillToCompany();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsOrderInformationBillToCompany);
    });
