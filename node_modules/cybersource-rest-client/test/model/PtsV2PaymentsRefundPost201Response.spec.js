...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PtsV2PaymentsRefundPost201Response();
  });
  ...
  describe('PtsV2PaymentsRefundPost201Response', function() {
    it('should create an instance of PtsV2PaymentsRefundPost201Response', function() {
      // uncomment below and update the code to test PtsV2PaymentsRefundPost201Response
      //var instane = new CyberSource.PtsV2PaymentsRefundPost201Response();
      //expect(instance).to.be.a(CyberSource.PtsV2PaymentsRefundPost201Response);
    });
    ...
    it('should have the property refundAmountDetails (base name: "refundAmountDetails")', function() {
      // uncomment below and update the code to test the property refundAmountDetails
      //var instane = new CyberSource.PtsV2PaymentsRefundPost201Response();
      //expect(instance).to.be();
    });
