...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.VoidRefundRequest();
  });
  ...
  describe('VoidRefundRequest', function() {
    it('should create an instance of VoidRefundRequest', function() {
      // uncomment below and update the code to test VoidRefundRequest
      //var instane = new CyberSource.VoidRefundRequest();
      //expect(instance).to.be.a(CyberSource.VoidRefundRequest);
    });
