...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TssV2TransactionsGet200ResponseClientReferenceInformation();
  });
  ...
  describe('TssV2TransactionsGet200ResponseClientReferenceInformation', function() {
    it('should create an instance of TssV2TransactionsGet200ResponseClientReferenceInformation', function() {
      // uncomment below and update the code to test TssV2TransactionsGet200ResponseClientReferenceInformation
      //var instane = new CyberSource.TssV2TransactionsGet200ResponseClientReferenceInformation();
      //expect(instance).to.be.a(CyberSource.TssV2TransactionsGet200ResponseClientReferenceInformation);
    });
