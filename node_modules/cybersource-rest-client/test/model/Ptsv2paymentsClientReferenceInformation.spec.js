...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsClientReferenceInformation();
  });
  ...
  describe('Ptsv2paymentsClientReferenceInformation', function() {
    it('should create an instance of Ptsv2paymentsClientReferenceInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentsClientReferenceInformation
      //var instane = new CyberSource.Ptsv2paymentsClientReferenceInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsClientReferenceInformation);
    });
