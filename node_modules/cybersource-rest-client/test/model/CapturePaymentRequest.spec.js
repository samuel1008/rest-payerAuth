...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CapturePaymentRequest();
  });
  ...
  describe('CapturePaymentRequest', function() {
    it('should create an instance of CapturePaymentRequest', function() {
      // uncomment below and update the code to test CapturePaymentRequest
      //var instane = new CyberSource.CapturePaymentRequest();
      //expect(instance).to.be.a(CyberSource.CapturePaymentRequest);
    });
