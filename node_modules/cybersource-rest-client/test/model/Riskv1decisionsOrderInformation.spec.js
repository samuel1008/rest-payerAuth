...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1decisionsOrderInformation();
  });
  ...
  describe('Riskv1decisionsOrderInformation', function() {
    it('should create an instance of Riskv1decisionsOrderInformation', function() {
      // uncomment below and update the code to test Riskv1decisionsOrderInformation
      //var instane = new CyberSource.Riskv1decisionsOrderInformation();
      //expect(instance).to.be.a(CyberSource.Riskv1decisionsOrderInformation);
    });
