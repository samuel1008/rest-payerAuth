...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1authenticationsOrderInformationBillTo();
  });
  ...
  describe('Riskv1authenticationsOrderInformationBillTo', function() {
    it('should create an instance of Riskv1authenticationsOrderInformationBillTo', function() {
      // uncomment below and update the code to test Riskv1authenticationsOrderInformationBillTo
      //var instane = new CyberSource.Riskv1authenticationsOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.Riskv1authenticationsOrderInformationBillTo);
    });
