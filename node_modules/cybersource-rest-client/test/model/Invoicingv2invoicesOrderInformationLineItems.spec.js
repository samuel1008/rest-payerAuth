...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Invoicingv2invoicesOrderInformationLineItems();
  });
  ...
  describe('Invoicingv2invoicesOrderInformationLineItems', function() {
    it('should create an instance of Invoicingv2invoicesOrderInformationLineItems', function() {
      // uncomment below and update the code to test Invoicingv2invoicesOrderInformationLineItems
      //var instane = new CyberSource.Invoicingv2invoicesOrderInformationLineItems();
      //expect(instance).to.be.a(CyberSource.Invoicingv2invoicesOrderInformationLineItems);
    });
