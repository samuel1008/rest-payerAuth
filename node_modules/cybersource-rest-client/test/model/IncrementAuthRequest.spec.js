...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.IncrementAuthRequest();
  });
  ...
  describe('IncrementAuthRequest', function() {
    it('should create an instance of IncrementAuthRequest', function() {
      // uncomment below and update the code to test IncrementAuthRequest
      //var instane = new CyberSource.IncrementAuthRequest();
      //expect(instance).to.be.a(CyberSource.IncrementAuthRequest);
    });
