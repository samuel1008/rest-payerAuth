...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Tmsv1instrumentidentifiersCard();
  });
  ...
  describe('Tmsv1instrumentidentifiersCard', function() {
    it('should create an instance of Tmsv1instrumentidentifiersCard', function() {
      // uncomment below and update the code to test Tmsv1instrumentidentifiersCard
      //var instane = new CyberSource.Tmsv1instrumentidentifiersCard();
      //expect(instance).to.be.a(CyberSource.Tmsv1instrumentidentifiersCard);
    });
