...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PtsV2PaymentsPost201ResponsePointOfSaleInformation();
  });
  ...
  describe('PtsV2PaymentsPost201ResponsePointOfSaleInformation', function() {
    it('should create an instance of PtsV2PaymentsPost201ResponsePointOfSaleInformation', function() {
      // uncomment below and update the code to test PtsV2PaymentsPost201ResponsePointOfSaleInformation
      //var instane = new CyberSource.PtsV2PaymentsPost201ResponsePointOfSaleInformation();
      //expect(instance).to.be.a(CyberSource.PtsV2PaymentsPost201ResponsePointOfSaleInformation);
    });
