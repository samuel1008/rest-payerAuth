...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TssV2TransactionsGet200ResponseOrderInformation();
  });
  ...
  describe('TssV2TransactionsGet200ResponseOrderInformation', function() {
    it('should create an instance of TssV2TransactionsGet200ResponseOrderInformation', function() {
      // uncomment below and update the code to test TssV2TransactionsGet200ResponseOrderInformation
      //var instane = new CyberSource.TssV2TransactionsGet200ResponseOrderInformation();
      //expect(instance).to.be.a(CyberSource.TssV2TransactionsGet200ResponseOrderInformation);
    });
