...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbeddedCard();
  });
  ...
  describe('TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbeddedCard', function() {
    it('should create an instance of TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbeddedCard', function() {
      // uncomment below and update the code to test TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbeddedCard
      //var instane = new CyberSource.TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbeddedCard();
      //expect(instance).to.be.a(CyberSource.TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbeddedCard);
    });
