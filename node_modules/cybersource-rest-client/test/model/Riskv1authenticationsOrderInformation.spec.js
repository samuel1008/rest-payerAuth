...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1authenticationsOrderInformation();
  });
  ...
  describe('Riskv1authenticationsOrderInformation', function() {
    it('should create an instance of Riskv1authenticationsOrderInformation', function() {
      // uncomment below and update the code to test Riskv1authenticationsOrderInformation
      //var instane = new CyberSource.Riskv1authenticationsOrderInformation();
      //expect(instance).to.be.a(CyberSource.Riskv1authenticationsOrderInformation);
    });
