...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TssV2TransactionsGet200ResponseOrderInformationBillTo();
  });
  ...
  describe('TssV2TransactionsGet200ResponseOrderInformationBillTo', function() {
    it('should create an instance of TssV2TransactionsGet200ResponseOrderInformationBillTo', function() {
      // uncomment below and update the code to test TssV2TransactionsGet200ResponseOrderInformationBillTo
      //var instane = new CyberSource.TssV2TransactionsGet200ResponseOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.TssV2TransactionsGet200ResponseOrderInformationBillTo);
    });
