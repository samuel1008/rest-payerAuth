...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsOrderInformationBillTo();
  });
  ...
  describe('Ptsv2paymentsOrderInformationBillTo', function() {
    it('should create an instance of Ptsv2paymentsOrderInformationBillTo', function() {
      // uncomment below and update the code to test Ptsv2paymentsOrderInformationBillTo
      //var instane = new CyberSource.Ptsv2paymentsOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsOrderInformationBillTo);
    });
