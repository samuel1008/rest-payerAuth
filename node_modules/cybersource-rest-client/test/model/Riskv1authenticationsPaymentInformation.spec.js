...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1authenticationsPaymentInformation();
  });
  ...
  describe('Riskv1authenticationsPaymentInformation', function() {
    it('should create an instance of Riskv1authenticationsPaymentInformation', function() {
      // uncomment below and update the code to test Riskv1authenticationsPaymentInformation
      //var instane = new CyberSource.Riskv1authenticationsPaymentInformation();
      //expect(instance).to.be.a(CyberSource.Riskv1authenticationsPaymentInformation);
    });
