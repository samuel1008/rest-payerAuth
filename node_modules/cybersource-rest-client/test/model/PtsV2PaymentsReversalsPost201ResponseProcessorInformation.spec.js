...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PtsV2PaymentsReversalsPost201ResponseProcessorInformation();
  });
  ...
  describe('PtsV2PaymentsReversalsPost201ResponseProcessorInformation', function() {
    it('should create an instance of PtsV2PaymentsReversalsPost201ResponseProcessorInformation', function() {
      // uncomment below and update the code to test PtsV2PaymentsReversalsPost201ResponseProcessorInformation
      //var instane = new CyberSource.PtsV2PaymentsReversalsPost201ResponseProcessorInformation();
      //expect(instance).to.be.a(CyberSource.PtsV2PaymentsReversalsPost201ResponseProcessorInformation);
    });
