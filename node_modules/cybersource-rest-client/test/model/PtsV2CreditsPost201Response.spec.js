...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PtsV2CreditsPost201Response();
  });
  ...
  describe('PtsV2CreditsPost201Response', function() {
    it('should create an instance of PtsV2CreditsPost201Response', function() {
      // uncomment below and update the code to test PtsV2CreditsPost201Response
      //var instane = new CyberSource.PtsV2CreditsPost201Response();
      //expect(instance).to.be.a(CyberSource.PtsV2CreditsPost201Response);
    });
    ...
    it('should have the property creditAmountDetails (base name: "creditAmountDetails")', function() {
      // uncomment below and update the code to test the property creditAmountDetails
      //var instane = new CyberSource.PtsV2CreditsPost201Response();
      //expect(instance).to.be();
    });
