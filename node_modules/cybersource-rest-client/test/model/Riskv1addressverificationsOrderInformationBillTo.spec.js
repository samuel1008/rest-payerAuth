...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1addressverificationsOrderInformationBillTo();
  });
  ...
  describe('Riskv1addressverificationsOrderInformationBillTo', function() {
    it('should create an instance of Riskv1addressverificationsOrderInformationBillTo', function() {
      // uncomment below and update the code to test Riskv1addressverificationsOrderInformationBillTo
      //var instane = new CyberSource.Riskv1addressverificationsOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.Riskv1addressverificationsOrderInformationBillTo);
    });
