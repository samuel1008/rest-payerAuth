...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CheckPayerAuthEnrollmentRequest();
  });
  ...
  describe('CheckPayerAuthEnrollmentRequest', function() {
    it('should create an instance of CheckPayerAuthEnrollmentRequest', function() {
      // uncomment below and update the code to test CheckPayerAuthEnrollmentRequest
      //var instane = new CyberSource.CheckPayerAuthEnrollmentRequest();
      //expect(instance).to.be.a(CyberSource.CheckPayerAuthEnrollmentRequest);
    });
