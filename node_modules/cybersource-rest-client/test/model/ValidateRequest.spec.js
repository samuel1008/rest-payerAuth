...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.ValidateRequest();
  });
  ...
  describe('ValidateRequest', function() {
    it('should create an instance of ValidateRequest', function() {
      // uncomment below and update the code to test ValidateRequest
      //var instane = new CyberSource.ValidateRequest();
      //expect(instance).to.be.a(CyberSource.ValidateRequest);
    });
