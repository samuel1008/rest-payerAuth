...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CreateCreditRequest();
  });
  ...
  describe('CreateCreditRequest', function() {
    it('should create an instance of CreateCreditRequest', function() {
      // uncomment below and update the code to test CreateCreditRequest
      //var instane = new CyberSource.CreateCreditRequest();
      //expect(instance).to.be.a(CyberSource.CreateCreditRequest);
    });
