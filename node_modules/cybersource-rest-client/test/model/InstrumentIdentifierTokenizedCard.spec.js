...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InstrumentIdentifierTokenizedCard();
  });
  ...
  describe('InstrumentIdentifierTokenizedCard', function() {
    it('should create an instance of InstrumentIdentifierTokenizedCard', function() {
      // uncomment below and update the code to test InstrumentIdentifierTokenizedCard
      //var instane = new CyberSource.InstrumentIdentifierTokenizedCard();
      //expect(instance).to.be.a(CyberSource.InstrumentIdentifierTokenizedCard);
    });
