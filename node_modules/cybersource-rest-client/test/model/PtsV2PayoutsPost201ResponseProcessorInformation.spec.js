...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PtsV2PayoutsPost201ResponseProcessorInformation();
  });
  ...
  describe('PtsV2PayoutsPost201ResponseProcessorInformation', function() {
    it('should create an instance of PtsV2PayoutsPost201ResponseProcessorInformation', function() {
      // uncomment below and update the code to test PtsV2PayoutsPost201ResponseProcessorInformation
      //var instane = new CyberSource.PtsV2PayoutsPost201ResponseProcessorInformation();
      //expect(instance).to.be.a(CyberSource.PtsV2PayoutsPost201ResponseProcessorInformation);
    });
