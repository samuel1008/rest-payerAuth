...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1authenticationresultsPaymentInformation();
  });
  ...
  describe('Riskv1authenticationresultsPaymentInformation', function() {
    it('should create an instance of Riskv1authenticationresultsPaymentInformation', function() {
      // uncomment below and update the code to test Riskv1authenticationresultsPaymentInformation
      //var instane = new CyberSource.Riskv1authenticationresultsPaymentInformation();
      //expect(instance).to.be.a(CyberSource.Riskv1authenticationresultsPaymentInformation);
    });
