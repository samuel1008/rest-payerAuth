...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsidreversalsProcessingInformation();
  });
  ...
  describe('Ptsv2paymentsidreversalsProcessingInformation', function() {
    it('should create an instance of Ptsv2paymentsidreversalsProcessingInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentsidreversalsProcessingInformation
      //var instane = new CyberSource.Ptsv2paymentsidreversalsProcessingInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsidreversalsProcessingInformation);
    });
