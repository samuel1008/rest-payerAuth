...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.OctCreatePaymentRequest();
  });
  ...
  describe('OctCreatePaymentRequest', function() {
    it('should create an instance of OctCreatePaymentRequest', function() {
      // uncomment below and update the code to test OctCreatePaymentRequest
      //var instane = new CyberSource.OctCreatePaymentRequest();
      //expect(instance).to.be.a(CyberSource.OctCreatePaymentRequest);
    });
