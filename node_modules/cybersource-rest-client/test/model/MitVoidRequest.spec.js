...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.MitVoidRequest();
  });
  ...
  describe('MitVoidRequest', function() {
    it('should create an instance of MitVoidRequest', function() {
      // uncomment below and update the code to test MitVoidRequest
      //var instane = new CyberSource.MitVoidRequest();
      //expect(instance).to.be.a(CyberSource.MitVoidRequest);
    });
