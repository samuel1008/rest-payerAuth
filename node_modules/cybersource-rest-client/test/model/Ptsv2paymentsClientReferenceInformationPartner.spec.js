...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsClientReferenceInformationPartner();
  });
  ...
  describe('Ptsv2paymentsClientReferenceInformationPartner', function() {
    it('should create an instance of Ptsv2paymentsClientReferenceInformationPartner', function() {
      // uncomment below and update the code to test Ptsv2paymentsClientReferenceInformationPartner
      //var instane = new CyberSource.Ptsv2paymentsClientReferenceInformationPartner();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsClientReferenceInformationPartner);
    });
