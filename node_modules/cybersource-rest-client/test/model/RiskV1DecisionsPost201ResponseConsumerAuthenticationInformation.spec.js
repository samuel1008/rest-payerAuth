...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation();
  });
  ...
  describe('RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation', function() {
    it('should create an instance of RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation', function() {
      // uncomment below and update the code to test RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation
      //var instane = new CyberSource.RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation();
      //expect(instance).to.be.a(CyberSource.RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation);
    });
