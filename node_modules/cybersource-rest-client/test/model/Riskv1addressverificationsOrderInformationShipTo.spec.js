...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1addressverificationsOrderInformationShipTo();
  });
  ...
  describe('Riskv1addressverificationsOrderInformationShipTo', function() {
    it('should create an instance of Riskv1addressverificationsOrderInformationShipTo', function() {
      // uncomment below and update the code to test Riskv1addressverificationsOrderInformationShipTo
      //var instane = new CyberSource.Riskv1addressverificationsOrderInformationShipTo();
      //expect(instance).to.be.a(CyberSource.Riskv1addressverificationsOrderInformationShipTo);
    });
