...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.ValidateExportComplianceRequest();
  });
  ...
  describe('ValidateExportComplianceRequest', function() {
    it('should create an instance of ValidateExportComplianceRequest', function() {
      // uncomment below and update the code to test ValidateExportComplianceRequest
      //var instane = new CyberSource.ValidateExportComplianceRequest();
      //expect(instance).to.be.a(CyberSource.ValidateExportComplianceRequest);
    });
