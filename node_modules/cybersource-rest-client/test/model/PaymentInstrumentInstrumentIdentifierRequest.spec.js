...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentInstrumentInstrumentIdentifierRequest();
  });
  ...
  describe('PaymentInstrumentInstrumentIdentifierRequest', function() {
    it('should create an instance of PaymentInstrumentInstrumentIdentifierRequest', function() {
      // uncomment below and update the code to test PaymentInstrumentInstrumentIdentifierRequest
      //var instane = new CyberSource.PaymentInstrumentInstrumentIdentifierRequest();
      //expect(instance).to.be.a(CyberSource.PaymentInstrumentInstrumentIdentifierRequest);
    });
