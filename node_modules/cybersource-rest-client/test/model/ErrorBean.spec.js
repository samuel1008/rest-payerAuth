...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.ErrorBean();
  });
  ...
  describe('ErrorBean', function() {
    it('should create an instance of ErrorBean', function() {
      // uncomment below and update the code to test ErrorBean
      //var instane = new CyberSource.ErrorBean();
      //expect(instance).to.be.a(CyberSource.ErrorBean);
    });
