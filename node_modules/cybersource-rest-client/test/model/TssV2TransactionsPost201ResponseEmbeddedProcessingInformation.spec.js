...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TssV2TransactionsPost201ResponseEmbeddedProcessingInformation();
  });
  ...
  describe('TssV2TransactionsPost201ResponseEmbeddedProcessingInformation', function() {
    it('should create an instance of TssV2TransactionsPost201ResponseEmbeddedProcessingInformation', function() {
      // uncomment below and update the code to test TssV2TransactionsPost201ResponseEmbeddedProcessingInformation
      //var instane = new CyberSource.TssV2TransactionsPost201ResponseEmbeddedProcessingInformation();
      //expect(instance).to.be.a(CyberSource.TssV2TransactionsPost201ResponseEmbeddedProcessingInformation);
    });
