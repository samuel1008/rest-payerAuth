...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.VoidPaymentRequest();
  });
  ...
  describe('VoidPaymentRequest', function() {
    it('should create an instance of VoidPaymentRequest', function() {
      // uncomment below and update the code to test VoidPaymentRequest
      //var instane = new CyberSource.VoidPaymentRequest();
      //expect(instance).to.be.a(CyberSource.VoidPaymentRequest);
    });
