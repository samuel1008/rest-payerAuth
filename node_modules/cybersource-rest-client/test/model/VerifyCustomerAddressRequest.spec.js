...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.VerifyCustomerAddressRequest();
  });
  ...
  describe('VerifyCustomerAddressRequest', function() {
    it('should create an instance of VerifyCustomerAddressRequest', function() {
      // uncomment below and update the code to test VerifyCustomerAddressRequest
      //var instane = new CyberSource.VerifyCustomerAddressRequest();
      //expect(instance).to.be.a(CyberSource.VerifyCustomerAddressRequest);
    });
