...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2payoutsProcessingInformationPayoutsOptions();
  });
  ...
  describe('Ptsv2payoutsProcessingInformationPayoutsOptions', function() {
    it('should create an instance of Ptsv2payoutsProcessingInformationPayoutsOptions', function() {
      // uncomment below and update the code to test Ptsv2payoutsProcessingInformationPayoutsOptions
      //var instane = new CyberSource.Ptsv2payoutsProcessingInformationPayoutsOptions();
      //expect(instance).to.be.a(CyberSource.Ptsv2payoutsProcessingInformationPayoutsOptions);
    });
