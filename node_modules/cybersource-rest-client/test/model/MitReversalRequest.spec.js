...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.MitReversalRequest();
  });
  ...
  describe('MitReversalRequest', function() {
    it('should create an instance of MitReversalRequest', function() {
      // uncomment below and update the code to test MitReversalRequest
      //var instane = new CyberSource.MitReversalRequest();
      //expect(instance).to.be.a(CyberSource.MitReversalRequest);
    });
