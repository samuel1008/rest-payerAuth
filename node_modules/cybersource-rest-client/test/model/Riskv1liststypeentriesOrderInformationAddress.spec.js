...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1liststypeentriesOrderInformationAddress();
  });
  ...
  describe('Riskv1liststypeentriesOrderInformationAddress', function() {
    it('should create an instance of Riskv1liststypeentriesOrderInformationAddress', function() {
      // uncomment below and update the code to test Riskv1liststypeentriesOrderInformationAddress
      //var instane = new CyberSource.Riskv1liststypeentriesOrderInformationAddress();
      //expect(instance).to.be.a(CyberSource.Riskv1liststypeentriesOrderInformationAddress);
    });
