...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1decisionsConsumerAuthenticationInformation();
  });
  ...
  describe('Riskv1decisionsConsumerAuthenticationInformation', function() {
    it('should create an instance of Riskv1decisionsConsumerAuthenticationInformation', function() {
      // uncomment below and update the code to test Riskv1decisionsConsumerAuthenticationInformation
      //var instane = new CyberSource.Riskv1decisionsConsumerAuthenticationInformation();
      //expect(instance).to.be.a(CyberSource.Riskv1decisionsConsumerAuthenticationInformation);
    });
