...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.VoidCaptureRequest();
  });
  ...
  describe('VoidCaptureRequest', function() {
    it('should create an instance of VoidCaptureRequest', function() {
      // uncomment below and update the code to test VoidCaptureRequest
      //var instane = new CyberSource.VoidCaptureRequest();
      //expect(instance).to.be.a(CyberSource.VoidCaptureRequest);
    });
