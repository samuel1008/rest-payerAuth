...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.RefundCaptureRequest();
  });
  ...
  describe('RefundCaptureRequest', function() {
    it('should create an instance of RefundCaptureRequest', function() {
      // uncomment below and update the code to test RefundCaptureRequest
      //var instane = new CyberSource.RefundCaptureRequest();
      //expect(instance).to.be.a(CyberSource.RefundCaptureRequest);
    });
