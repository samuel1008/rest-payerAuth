...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Invoicingv2invoicesOrderInformationAmountDetails();
  });
  ...
  describe('Invoicingv2invoicesOrderInformationAmountDetails', function() {
    it('should create an instance of Invoicingv2invoicesOrderInformationAmountDetails', function() {
      // uncomment below and update the code to test Invoicingv2invoicesOrderInformationAmountDetails
      //var instane = new CyberSource.Invoicingv2invoicesOrderInformationAmountDetails();
      //expect(instance).to.be.a(CyberSource.Invoicingv2invoicesOrderInformationAmountDetails);
    });
