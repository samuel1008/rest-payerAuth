...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.EmbeddedInstrumentIdentifierResponse();
  });
  ...
  describe('EmbeddedInstrumentIdentifierResponse', function() {
    it('should create an instance of EmbeddedInstrumentIdentifierResponse', function() {
      // uncomment below and update the code to test EmbeddedInstrumentIdentifierResponse
      //var instane = new CyberSource.EmbeddedInstrumentIdentifierResponse();
      //expect(instance).to.be.a(CyberSource.EmbeddedInstrumentIdentifierResponse);
    });
