...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsidrefundsMerchantInformation();
  });
  ...
  describe('Ptsv2paymentsidrefundsMerchantInformation', function() {
    it('should create an instance of Ptsv2paymentsidrefundsMerchantInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentsidrefundsMerchantInformation
      //var instane = new CyberSource.Ptsv2paymentsidrefundsMerchantInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsidrefundsMerchantInformation);
    });
