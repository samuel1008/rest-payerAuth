...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InstrumentIdentifierResponse();
  });
  ...
  describe('InstrumentIdentifierResponse', function() {
    it('should create an instance of InstrumentIdentifierResponse', function() {
      // uncomment below and update the code to test InstrumentIdentifierResponse
      //var instane = new CyberSource.InstrumentIdentifierResponse();
      //expect(instance).to.be.a(CyberSource.InstrumentIdentifierResponse);
    });
