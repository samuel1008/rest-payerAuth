...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsidrefundsPaymentInformationCard();
  });
  ...
  describe('Ptsv2paymentsidrefundsPaymentInformationCard', function() {
    it('should create an instance of Ptsv2paymentsidrefundsPaymentInformationCard', function() {
      // uncomment below and update the code to test Ptsv2paymentsidrefundsPaymentInformationCard
      //var instane = new CyberSource.Ptsv2paymentsidrefundsPaymentInformationCard();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsidrefundsPaymentInformationCard);
    });
