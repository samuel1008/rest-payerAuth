...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsidcapturesBuyerInformation();
  });
  ...
  describe('Ptsv2paymentsidcapturesBuyerInformation', function() {
    it('should create an instance of Ptsv2paymentsidcapturesBuyerInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentsidcapturesBuyerInformation
      //var instane = new CyberSource.Ptsv2paymentsidcapturesBuyerInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsidcapturesBuyerInformation);
    });
