...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TmsV1InstrumentIdentifiersPost200ResponseLinks();
  });
  ...
  describe('TmsV1InstrumentIdentifiersPost200ResponseLinks', function() {
    it('should create an instance of TmsV1InstrumentIdentifiersPost200ResponseLinks', function() {
      // uncomment below and update the code to test TmsV1InstrumentIdentifiersPost200ResponseLinks
      //var instane = new CyberSource.TmsV1InstrumentIdentifiersPost200ResponseLinks();
      //expect(instance).to.be.a(CyberSource.TmsV1InstrumentIdentifiersPost200ResponseLinks);
    });
