...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1exportcomplianceinquiriesOrderInformationBillTo();
  });
  ...
  describe('Riskv1exportcomplianceinquiriesOrderInformationBillTo', function() {
    it('should create an instance of Riskv1exportcomplianceinquiriesOrderInformationBillTo', function() {
      // uncomment below and update the code to test Riskv1exportcomplianceinquiriesOrderInformationBillTo
      //var instane = new CyberSource.Riskv1exportcomplianceinquiriesOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.Riskv1exportcomplianceinquiriesOrderInformationBillTo);
    });
