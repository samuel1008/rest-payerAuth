...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsBuyerInformation();
  });
  ...
  describe('Ptsv2paymentsBuyerInformation', function() {
    it('should create an instance of Ptsv2paymentsBuyerInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentsBuyerInformation
      //var instane = new CyberSource.Ptsv2paymentsBuyerInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsBuyerInformation);
    });
