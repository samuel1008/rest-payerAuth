...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PtsV2PaymentsPost201ResponsePaymentInformationTokenizedCard();
  });
  ...
  describe('PtsV2PaymentsPost201ResponsePaymentInformationTokenizedCard', function() {
    it('should create an instance of PtsV2PaymentsPost201ResponsePaymentInformationTokenizedCard', function() {
      // uncomment below and update the code to test PtsV2PaymentsPost201ResponsePaymentInformationTokenizedCard
      //var instane = new CyberSource.PtsV2PaymentsPost201ResponsePaymentInformationTokenizedCard();
      //expect(instance).to.be.a(CyberSource.PtsV2PaymentsPost201ResponsePaymentInformationTokenizedCard);
    });
