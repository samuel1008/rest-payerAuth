...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsidrefundsOrderInformation();
  });
  ...
  describe('Ptsv2paymentsidrefundsOrderInformation', function() {
    it('should create an instance of Ptsv2paymentsidrefundsOrderInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentsidrefundsOrderInformation
      //var instane = new CyberSource.Ptsv2paymentsidrefundsOrderInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsidrefundsOrderInformation);
    });
