...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsAcquirerInformation();
  });
  ...
  describe('Ptsv2paymentsAcquirerInformation', function() {
    it('should create an instance of Ptsv2paymentsAcquirerInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentsAcquirerInformation
      //var instane = new CyberSource.Ptsv2paymentsAcquirerInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsAcquirerInformation);
    });
