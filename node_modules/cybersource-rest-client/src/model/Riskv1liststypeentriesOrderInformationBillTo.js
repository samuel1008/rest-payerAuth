...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1liststypeentriesOrderInformationBillTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Riskv1liststypeentriesOrderInformationBillTo model module.
   * @module model/Riskv1liststypeentriesOrderInformationBillTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Riskv1liststypeentriesOrderInformationBillTo</code>.
   * @alias module:model/Riskv1liststypeentriesOrderInformationBillTo
   * @class
   */
  ...
  /**
   * Constructs a <code>Riskv1liststypeentriesOrderInformationBillTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Riskv1liststypeentriesOrderInformationBillTo} obj Optional instance to populate.
   * @return {module:model/Riskv1liststypeentriesOrderInformationBillTo} The populated <code>Riskv1liststypeentriesOrderInformationBillTo</code> instance.
   */
