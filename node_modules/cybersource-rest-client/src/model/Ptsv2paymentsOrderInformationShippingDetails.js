...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Ptsv2paymentsOrderInformationShippingDetails = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Ptsv2paymentsOrderInformationShippingDetails model module.
   * @module model/Ptsv2paymentsOrderInformationShippingDetails
   * @version 0.0.1
   */
  ...
  /**
   * Constructs a <code>Ptsv2paymentsOrderInformationShippingDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv2paymentsOrderInformationShippingDetails} obj Optional instance to populate.
   * @return {module:model/Ptsv2paymentsOrderInformationShippingDetails} The populated <code>Ptsv2paymentsOrderInformationShippingDetails</code> instance.
   */
