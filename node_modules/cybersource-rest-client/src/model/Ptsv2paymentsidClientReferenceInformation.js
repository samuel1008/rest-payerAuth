...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Ptsv2paymentsidClientReferenceInformationPartner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Ptsv2paymentsidClientReferenceInformationPartner'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.Ptsv2paymentsidClientReferenceInformation = factory(root.CyberSource.ApiClient, root.CyberSource.Ptsv2paymentsidClientReferenceInformationPartner);
  }
}(this, function(ApiClient, Ptsv2paymentsidClientReferenceInformationPartner) {
  'use strict';
  ...
  /**
   * The Ptsv2paymentsidClientReferenceInformation model module.
   * @module model/Ptsv2paymentsidClientReferenceInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv2paymentsidClientReferenceInformation</code>.
   * @alias module:model/Ptsv2paymentsidClientReferenceInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv2paymentsidClientReferenceInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv2paymentsidClientReferenceInformation} obj Optional instance to populate.
   * @return {module:model/Ptsv2paymentsidClientReferenceInformation} The populated <code>Ptsv2paymentsidClientReferenceInformation</code> instance.
   */
