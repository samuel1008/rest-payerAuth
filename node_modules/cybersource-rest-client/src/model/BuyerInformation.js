...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>BuyerInformation</code>.
  ...
  /**
   * Constructs a <code>BuyerInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BuyerInformation} obj Optional instance to populate.
   * @return {module:model/BuyerInformation} The populated <code>BuyerInformation</code> instance.
   */
