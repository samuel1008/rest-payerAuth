...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>PaymentInstrumentsArray</code>.
  ...
  /**
   * Constructs a <code>PaymentInstrumentsArray</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentInstrumentsArray} obj Optional instance to populate.
   * @return {module:model/PaymentInstrumentsArray} The populated <code>PaymentInstrumentsArray</code> instance.
   */
