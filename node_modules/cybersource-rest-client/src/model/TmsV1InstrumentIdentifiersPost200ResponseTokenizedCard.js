...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.TmsV1InstrumentIdentifiersPost200ResponseTokenizedCard = factory(root.CyberSource.ApiClient, root.CyberSource.TmsV1InstrumentIdentifiersPost200ResponseTokenizedCardCard);
  }
  ...
  /**
   * The TmsV1InstrumentIdentifiersPost200ResponseTokenizedCard model module.
   * @module model/TmsV1InstrumentIdentifiersPost200ResponseTokenizedCard
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>TmsV1InstrumentIdentifiersPost200ResponseTokenizedCard</code>.
   * The Network Token associated with the Instrument Identifier (PAN)
   * @alias module:model/TmsV1InstrumentIdentifiersPost200ResponseTokenizedCard
   * @class
   */
  ...
  /**
   * Constructs a <code>TmsV1InstrumentIdentifiersPost200ResponseTokenizedCard</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TmsV1InstrumentIdentifiersPost200ResponseTokenizedCard} obj Optional instance to populate.
   * @return {module:model/TmsV1InstrumentIdentifiersPost200ResponseTokenizedCard} The populated <code>TmsV1InstrumentIdentifiersPost200ResponseTokenizedCard</code> instance.
   */
