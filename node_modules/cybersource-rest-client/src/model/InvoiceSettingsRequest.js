...
(function(root, factory) {
  ...
  /**
   * The InvoiceSettingsRequest model module.
   * @module model/InvoiceSettingsRequest
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InvoiceSettingsRequest</code>.
   * @alias module:model/InvoiceSettingsRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceSettingsRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceSettingsRequest} obj Optional instance to populate.
   * @return {module:model/InvoiceSettingsRequest} The populated <code>InvoiceSettingsRequest</code> instance.
   */
