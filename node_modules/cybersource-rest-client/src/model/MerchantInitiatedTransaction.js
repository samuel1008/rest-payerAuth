...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>MerchantInitiatedTransaction</code>.
  ...
  /**
   * Constructs a <code>MerchantInitiatedTransaction</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MerchantInitiatedTransaction} obj Optional instance to populate.
   * @return {module:model/MerchantInitiatedTransaction} The populated <code>MerchantInitiatedTransaction</code> instance.
   */
