...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1authenticationsOrderInformationAmountDetails = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Riskv1authenticationsOrderInformationAmountDetails model module.
   * @module model/Riskv1authenticationsOrderInformationAmountDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Riskv1authenticationsOrderInformationAmountDetails</code>.
   * Contains &#x60;currency&#x60; and &#x60;totalAmount&#x60; for this order.
   * @alias module:model/Riskv1authenticationsOrderInformationAmountDetails
   * @class
   ...
   */
  var exports = function(currency, totalAmount) {
    var _this = this;
  ...
  /**
   * Constructs a <code>Riskv1authenticationsOrderInformationAmountDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Riskv1authenticationsOrderInformationAmountDetails} obj Optional instance to populate.
   * @return {module:model/Riskv1authenticationsOrderInformationAmountDetails} The populated <code>Riskv1authenticationsOrderInformationAmountDetails</code> instance.
   */
