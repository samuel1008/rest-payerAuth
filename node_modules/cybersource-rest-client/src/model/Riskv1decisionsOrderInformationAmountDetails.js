...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1decisionsOrderInformationAmountDetails = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Riskv1decisionsOrderInformationAmountDetails model module.
   * @module model/Riskv1decisionsOrderInformationAmountDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Riskv1decisionsOrderInformationAmountDetails</code>.
  ...
  /**
   * Constructs a <code>Riskv1decisionsOrderInformationAmountDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Riskv1decisionsOrderInformationAmountDetails} obj Optional instance to populate.
   * @return {module:model/Riskv1decisionsOrderInformationAmountDetails} The populated <code>Riskv1decisionsOrderInformationAmountDetails</code> instance.
   */
