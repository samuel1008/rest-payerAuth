...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.FlexV1KeysPost200Response = factory(root.CyberSource.ApiClient, root.CyberSource.FlexV1KeysPost200ResponseDer, root.CyberSource.FlexV1KeysPost200ResponseJwk);
  }
  ...
  /**
   * The FlexV1KeysPost200Response model module.
   * @module model/FlexV1KeysPost200Response
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>FlexV1KeysPost200Response</code>.
   * @alias module:model/FlexV1KeysPost200Response
   * @class
   */
  ...
  /**
   * Constructs a <code>FlexV1KeysPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FlexV1KeysPost200Response} obj Optional instance to populate.
   * @return {module:model/FlexV1KeysPost200Response} The populated <code>FlexV1KeysPost200Response</code> instance.
   */
