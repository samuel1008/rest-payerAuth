...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.EmbeddedInstrumentIdentifierResponse = factory(root.CyberSource.ApiClient, root.CyberSource.TmsV1InstrumentIdentifiersPost200ResponseCard, root.CyberSource.TmsV1InstrumentIdentifiersPost200ResponseIssuer, root.CyberSource.TmsV1InstrumentIdentifiersPost200ResponseLinks, root.CyberSource.TmsV1InstrumentIdentifiersPost200ResponseMetadata, root.CyberSource.TmsV1InstrumentIdentifiersPost200ResponseProcessingInformation, root.CyberSource.TmsV1InstrumentIdentifiersPost200ResponseTokenizedCard, root.CyberSource.Tmsv1instrumentidentifiersBankAccount);
  }
  ...
  /**
   * The EmbeddedInstrumentIdentifierResponse model module.
   * @module model/EmbeddedInstrumentIdentifierResponse
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>EmbeddedInstrumentIdentifierResponse</code>.
   * @alias module:model/EmbeddedInstrumentIdentifierResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>EmbeddedInstrumentIdentifierResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EmbeddedInstrumentIdentifierResponse} obj Optional instance to populate.
   * @return {module:model/EmbeddedInstrumentIdentifierResponse} The populated <code>EmbeddedInstrumentIdentifierResponse</code> instance.
   */
