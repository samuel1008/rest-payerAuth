...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1decisionsOrderInformationShippingDetails = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Riskv1decisionsOrderInformationShippingDetails model module.
   * @module model/Riskv1decisionsOrderInformationShippingDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Riskv1decisionsOrderInformationShippingDetails</code>.
   * Contains shipping information not related to address.
   * @alias module:model/Riskv1decisionsOrderInformationShippingDetails
   * @class
   */
  ...
  /**
   * Constructs a <code>Riskv1decisionsOrderInformationShippingDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Riskv1decisionsOrderInformationShippingDetails} obj Optional instance to populate.
   * @return {module:model/Riskv1decisionsOrderInformationShippingDetails} The populated <code>Riskv1decisionsOrderInformationShippingDetails</code> instance.
   */
