...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InvoicingV2InvoicesAllGet400Response = factory(root.CyberSource.ApiClient, root.CyberSource.PtsV2PaymentsPost201ResponseErrorInformationDetails);
  }
  ...
  /**
   * The InvoicingV2InvoicesAllGet400Response model module.
   * @module model/InvoicingV2InvoicesAllGet400Response
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InvoicingV2InvoicesAllGet400Response</code>.
   * @alias module:model/InvoicingV2InvoicesAllGet400Response
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoicingV2InvoicesAllGet400Response</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoicingV2InvoicesAllGet400Response} obj Optional instance to populate.
   * @return {module:model/InvoicingV2InvoicesAllGet400Response} The populated <code>InvoicingV2InvoicesAllGet400Response</code> instance.
   */
