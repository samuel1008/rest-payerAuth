...
(function(root, factory) {
  ...
  /**
   * The PaymentInstrumentInstrumentIdentifierRequest model module.
   * @module model/PaymentInstrumentInstrumentIdentifierRequest
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PaymentInstrumentInstrumentIdentifierRequest</code>.
   * @alias module:model/PaymentInstrumentInstrumentIdentifierRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentInstrumentInstrumentIdentifierRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentInstrumentInstrumentIdentifierRequest} obj Optional instance to populate.
   * @return {module:model/PaymentInstrumentInstrumentIdentifierRequest} The populated <code>PaymentInstrumentInstrumentIdentifierRequest</code> instance.
   */
