...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Ptsv2paymentsOrderInformationLineItems', 'model/Ptsv2paymentsidcapturesOrderInformationAmountDetails', 'model/Ptsv2paymentsidcapturesOrderInformationBillTo', 'model/Ptsv2paymentsidcapturesOrderInformationInvoiceDetails', 'model/Ptsv2paymentsidcapturesOrderInformationShipTo', 'model/Ptsv2paymentsidcapturesOrderInformationShippingDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Ptsv2paymentsOrderInformationLineItems'), require('./Ptsv2paymentsidcapturesOrderInformationAmountDetails'), require('./Ptsv2paymentsidcapturesOrderInformationBillTo'), require('./Ptsv2paymentsidcapturesOrderInformationInvoiceDetails'), require('./Ptsv2paymentsidcapturesOrderInformationShipTo'), require('./Ptsv2paymentsidcapturesOrderInformationShippingDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.Ptsv2paymentsidcapturesOrderInformation = factory(root.CyberSource.ApiClient, root.CyberSource.Ptsv2paymentsOrderInformationLineItems, root.CyberSource.Ptsv2paymentsidcapturesOrderInformationAmountDetails, root.CyberSource.Ptsv2paymentsidcapturesOrderInformationBillTo, root.CyberSource.Ptsv2paymentsidcapturesOrderInformationInvoiceDetails, root.CyberSource.Ptsv2paymentsidcapturesOrderInformationShipTo, root.CyberSource.Ptsv2paymentsidcapturesOrderInformationShippingDetails);
  }
}(this, function(ApiClient, Ptsv2paymentsOrderInformationLineItems, Ptsv2paymentsidcapturesOrderInformationAmountDetails, Ptsv2paymentsidcapturesOrderInformationBillTo, Ptsv2paymentsidcapturesOrderInformationInvoiceDetails, Ptsv2paymentsidcapturesOrderInformationShipTo, Ptsv2paymentsidcapturesOrderInformationShippingDetails) {
  'use strict';
  ...
  /**
   * The Ptsv2paymentsidcapturesOrderInformation model module.
   * @module model/Ptsv2paymentsidcapturesOrderInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv2paymentsidcapturesOrderInformation</code>.
   * @alias module:model/Ptsv2paymentsidcapturesOrderInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv2paymentsidcapturesOrderInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv2paymentsidcapturesOrderInformation} obj Optional instance to populate.
   * @return {module:model/Ptsv2paymentsidcapturesOrderInformation} The populated <code>Ptsv2paymentsidcapturesOrderInformation</code> instance.
   */
