...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation = factory(root.CyberSource.ApiClient, root.CyberSource.PtsV2PaymentsPost201ResponseConsumerAuthenticationInformationIvr);
  }
  ...
  /**
   * The RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation model module.
   * @module model/RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation</code>.
   * @alias module:model/RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation} obj Optional instance to populate.
   * @return {module:model/RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation} The populated <code>RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation</code> instance.
   */
