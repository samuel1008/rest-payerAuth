...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>MerchantInformation</code>.
  ...
  /**
   * Constructs a <code>MerchantInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MerchantInformation} obj Optional instance to populate.
   * @return {module:model/MerchantInformation} The populated <code>MerchantInformation</code> instance.
   */
