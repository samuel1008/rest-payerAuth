...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PtsV1TransactionBatchesIdGet200ResponseLinks'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PtsV1TransactionBatchesIdGet200ResponseLinks'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.PtsV1TransactionBatchesIdGet200Response = factory(root.CyberSource.ApiClient, root.CyberSource.PtsV1TransactionBatchesIdGet200ResponseLinks);
  }
}(this, function(ApiClient, PtsV1TransactionBatchesIdGet200ResponseLinks) {
  'use strict';
  ...
  /**
   * The PtsV1TransactionBatchesIdGet200Response model module.
   * @module model/PtsV1TransactionBatchesIdGet200Response
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PtsV1TransactionBatchesIdGet200Response</code>.
   * @alias module:model/PtsV1TransactionBatchesIdGet200Response
   * @class
   */
  ...
  /**
   * Constructs a <code>PtsV1TransactionBatchesIdGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PtsV1TransactionBatchesIdGet200Response} obj Optional instance to populate.
   * @return {module:model/PtsV1TransactionBatchesIdGet200Response} The populated <code>PtsV1TransactionBatchesIdGet200Response</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('_links')) {
        obj['_links'] = PtsV1TransactionBatchesIdGet200ResponseLinks.constructFromObject(data['_links']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/PtsV1TransactionBatchesIdGet200ResponseLinks} _links
   */
