...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.TokenizeRequest = factory(root.CyberSource.ApiClient, root.CyberSource.Flexv1tokensCardInfo);
  }
  ...
  /**
   * The TokenizeRequest model module.
   * @module model/TokenizeRequest
   * @version 0.0.1
   */
  ...
  /**
   * Constructs a <code>TokenizeRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TokenizeRequest} obj Optional instance to populate.
   * @return {module:model/TokenizeRequest} The populated <code>TokenizeRequest</code> instance.
   */
