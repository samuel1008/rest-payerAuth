...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.PtsV2PaymentsPost201ResponseRiskInformationIpAddress = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The PtsV2PaymentsPost201ResponseRiskInformationIpAddress model module.
   * @module model/PtsV2PaymentsPost201ResponseRiskInformationIpAddress
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PtsV2PaymentsPost201ResponseRiskInformationIpAddress</code>.
   * Contains detailed response information about the customer&#39;s IP address.
   * @alias module:model/PtsV2PaymentsPost201ResponseRiskInformationIpAddress
   * @class
   */
  ...
  /**
   * Constructs a <code>PtsV2PaymentsPost201ResponseRiskInformationIpAddress</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PtsV2PaymentsPost201ResponseRiskInformationIpAddress} obj Optional instance to populate.
