...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1decisionsPaymentInformationCard = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Riskv1decisionsPaymentInformationCard model module.
   * @module model/Riskv1decisionsPaymentInformationCard
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Riskv1decisionsPaymentInformationCard</code>.
   * Use this for a non-tokenized payment card.
   * @alias module:model/Riskv1decisionsPaymentInformationCard
   * @class
   */
  ...
  /**
   * Constructs a <code>Riskv1decisionsPaymentInformationCard</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Riskv1decisionsPaymentInformationCard} obj Optional instance to populate.
   * @return {module:model/Riskv1decisionsPaymentInformationCard} The populated <code>Riskv1decisionsPaymentInformationCard</code> instance.
   */
