...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1authenticationsOrderInformationBillTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Riskv1authenticationsOrderInformationBillTo model module.
   * @module model/Riskv1authenticationsOrderInformationBillTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Riskv1authenticationsOrderInformationBillTo</code>.
   ...
   */
  var exports = function(address1, administrativeArea, country, firstName, lastName, email, postalCode) {
    var _this = this;
  ...
  /**
   * Constructs a <code>Riskv1authenticationsOrderInformationBillTo</code> from a plain JavaScript object, optionally creating a new instance.
   ...
   * @return {module:model/Riskv1authenticationsOrderInformationBillTo} The populated <code>Riskv1authenticationsOrderInformationBillTo</code> instance.
   */
