...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InvoicingV2InvoicesPost202Response = factory(root.CyberSource.ApiClient, root.CyberSource.PtsV2PaymentsPost201ResponseErrorInformationDetails);
  }
  ...
  /**
   * The InvoicingV2InvoicesPost202Response model module.
   * @module model/InvoicingV2InvoicesPost202Response
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InvoicingV2InvoicesPost202Response</code>.
   * @alias module:model/InvoicingV2InvoicesPost202Response
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoicingV2InvoicesPost202Response</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoicingV2InvoicesPost202Response} obj Optional instance to populate.
   * @return {module:model/InvoicingV2InvoicesPost202Response} The populated <code>InvoicingV2InvoicesPost202Response</code> instance.
   */
