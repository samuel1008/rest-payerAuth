...
(function(root, factory) {
  ...
  /**
   * The Ptsv2paymentsidrefundsPointOfSaleInformation model module.
   * @module model/Ptsv2paymentsidrefundsPointOfSaleInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv2paymentsidrefundsPointOfSaleInformation</code>.
   * @alias module:model/Ptsv2paymentsidrefundsPointOfSaleInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv2paymentsidrefundsPointOfSaleInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv2paymentsidrefundsPointOfSaleInformation} obj Optional instance to populate.
   * @return {module:model/Ptsv2paymentsidrefundsPointOfSaleInformation} The populated <code>Ptsv2paymentsidrefundsPointOfSaleInformation</code> instance.
   */
