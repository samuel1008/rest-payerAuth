...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.PtsV2PaymentsCapturesPost400Response = factory(root.CyberSource.ApiClient, root.CyberSource.PtsV2PaymentsPost201ResponseErrorInformationDetails);
  }
  ...
  /**
   * The PtsV2PaymentsCapturesPost400Response model module.
   * @module model/PtsV2PaymentsCapturesPost400Response
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PtsV2PaymentsCapturesPost400Response</code>.
   * @alias module:model/PtsV2PaymentsCapturesPost400Response
   * @class
   */
  ...
  /**
   * Constructs a <code>PtsV2PaymentsCapturesPost400Response</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PtsV2PaymentsCapturesPost400Response} obj Optional instance to populate.
   * @return {module:model/PtsV2PaymentsCapturesPost400Response} The populated <code>PtsV2PaymentsCapturesPost400Response</code> instance.
   */
