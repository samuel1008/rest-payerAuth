...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('minimumTotalCount')) {
        obj['minimumTotalCount'] = ApiClient.convertToType(data['minimumTotalCount'], 'String');
      }
      if (data.hasOwnProperty('maximumTotalCount')) {
        obj['maximumTotalCount'] = ApiClient.convertToType(data['maximumTotalCount'], 'String');
      }
   ...
   * @member {String} minimumTotalCount
   */
  exports.prototype['minimumTotalCount'] = undefined;
  /**
   ...
   * @member {String} maximumTotalCount
   */
  exports.prototype['maximumTotalCount'] = undefined;
  /**
