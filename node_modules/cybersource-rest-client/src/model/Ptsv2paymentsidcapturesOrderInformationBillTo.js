...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Ptsv2paymentsidcapturesOrderInformationBillTo = factory(root.CyberSource.ApiClient, root.CyberSource.Ptsv2paymentsOrderInformationBillToCompany);
  }
  ...
  /**
   * The Ptsv2paymentsidcapturesOrderInformationBillTo model module.
   * @module model/Ptsv2paymentsidcapturesOrderInformationBillTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv2paymentsidcapturesOrderInformationBillTo</code>.
   * @alias module:model/Ptsv2paymentsidcapturesOrderInformationBillTo
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv2paymentsidcapturesOrderInformationBillTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv2paymentsidcapturesOrderInformationBillTo} obj Optional instance to populate.
   * @return {module:model/Ptsv2paymentsidcapturesOrderInformationBillTo} The populated <code>Ptsv2paymentsidcapturesOrderInformationBillTo</code> instance.
   */
