...
(function(root, factory) {
  ...
  /**
   * The PtsV2CreditsPost201Response model module.
   * @module model/PtsV2CreditsPost201Response
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PtsV2CreditsPost201Response</code>.
   * @alias module:model/PtsV2CreditsPost201Response
   * @class
   */
  ...
  /**
   * Constructs a <code>PtsV2CreditsPost201Response</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PtsV2CreditsPost201Response} obj Optional instance to populate.
   * @return {module:model/PtsV2CreditsPost201Response} The populated <code>PtsV2CreditsPost201Response</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('creditAmountDetails')) {
        obj['creditAmountDetails'] = PtsV2CreditsPost201ResponseCreditAmountDetails.constructFromObject(data['creditAmountDetails']);
      }
      if (data.hasOwnProperty('processingInformation')) {
        obj['processingInformation'] = PtsV2CreditsPost201ResponseProcessingInformation.constructFromObject(data['processingInformation']);
      }
      ...
      if (data.hasOwnProperty('paymentInformation')) {
        obj['paymentInformation'] = PtsV2CreditsPost201ResponsePaymentInformation.constructFromObject(data['paymentInformation']);
      }
  ...
  /**
   * @member {module:model/PtsV2CreditsPost201ResponseCreditAmountDetails} creditAmountDetails
   */
  exports.prototype['creditAmountDetails'] = undefined;
  /**
   * @member {module:model/PtsV2CreditsPost201ResponseProcessingInformation} processingInformation
   */
  ...
  /**
   * @member {module:model/PtsV2CreditsPost201ResponsePaymentInformation} paymentInformation
   */
