...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Flexv1tokensCardInfo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Flexv1tokensCardInfo model module.
   * @module model/Flexv1tokensCardInfo
   * @version 0.0.1
   */
  ...
  /**
   * Constructs a <code>Flexv1tokensCardInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Flexv1tokensCardInfo} obj Optional instance to populate.
   * @return {module:model/Flexv1tokensCardInfo} The populated <code>Flexv1tokensCardInfo</code> instance.
   */
