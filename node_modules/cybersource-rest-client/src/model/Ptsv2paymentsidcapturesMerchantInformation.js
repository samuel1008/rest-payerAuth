...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Ptsv2paymentsidcapturesMerchantInformation = factory(root.CyberSource.ApiClient, root.CyberSource.Ptsv2paymentsMerchantInformationMerchantDescriptor, root.CyberSource.Ptsv2paymentsMerchantInformationServiceFeeDescriptor);
  }
  ...
  /**
   * The Ptsv2paymentsidcapturesMerchantInformation model module.
   * @module model/Ptsv2paymentsidcapturesMerchantInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv2paymentsidcapturesMerchantInformation</code>.
   * @alias module:model/Ptsv2paymentsidcapturesMerchantInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv2paymentsidcapturesMerchantInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv2paymentsidcapturesMerchantInformation} obj Optional instance to populate.
   * @return {module:model/Ptsv2paymentsidcapturesMerchantInformation} The populated <code>Ptsv2paymentsidcapturesMerchantInformation</code> instance.
   */
