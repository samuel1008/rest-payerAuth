...
(function(root, factory) {
  ...
  /**
   * The CreatePaymentInstrumentRequest model module.
   * @module model/CreatePaymentInstrumentRequest
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>CreatePaymentInstrumentRequest</code>.
   * @alias module:model/CreatePaymentInstrumentRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>CreatePaymentInstrumentRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreatePaymentInstrumentRequest} obj Optional instance to populate.
   * @return {module:model/CreatePaymentInstrumentRequest} The populated <code>CreatePaymentInstrumentRequest</code> instance.
   */
