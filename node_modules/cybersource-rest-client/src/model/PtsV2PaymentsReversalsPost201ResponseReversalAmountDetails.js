...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.PtsV2PaymentsReversalsPost201ResponseReversalAmountDetails = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The PtsV2PaymentsReversalsPost201ResponseReversalAmountDetails model module.
   * @module model/PtsV2PaymentsReversalsPost201ResponseReversalAmountDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PtsV2PaymentsReversalsPost201ResponseReversalAmountDetails</code>.
   * @alias module:model/PtsV2PaymentsReversalsPost201ResponseReversalAmountDetails
   * @class
   */
  ...
  /**
   * Constructs a <code>PtsV2PaymentsReversalsPost201ResponseReversalAmountDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PtsV2PaymentsReversalsPost201ResponseReversalAmountDetails} obj Optional instance to populate.
   * @return {module:model/PtsV2PaymentsReversalsPost201ResponseReversalAmountDetails} The populated <code>PtsV2PaymentsReversalsPost201ResponseReversalAmountDetails</code> instance.
   */
