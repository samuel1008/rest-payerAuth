...
(function(root, factory) {
  ...
  var exports = function(configObject, apiClient) {
     ...
     * @param {String} opts.format Indicator to enable the receipt of the Keys response in Flex 11+ format (JWT) or legacy (parameter not required) (default to legacy)
     ...
     */
    this.generatePublicKey = function(generatePublicKeyRequest, opts, callback) {
      opts = opts || {};
